...
function initGame() {
    ...
    if (gameState.currentTurn === 'ai') {
        ...
        setTimeout(doAITurn, getOpponentThinkDelay());
    }
}
...
function updateModeSpecificUI() {
    ...
    document.querySelectorAll('.training-only').forEach(el => {
        el.classList.toggle('hidden', onlineMatch.active || onlineMatch.searching);
    });
    ...
    if (gameState.selectedPiece === null) {
        ...
        if (moveTarget) {
            ...
            animateMove(piece, fromCol, fromRow, moveTarget.col, moveTarget.row, capturedPiece, () => {
                ...
                setTimeout(doAITurn, getOpponentThinkDelay() + 1200);
            });
